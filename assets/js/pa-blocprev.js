...
function priceFormat(unprix, unformat) {
    let prixduformat = '';
    let photosurlemur = document.querySelector('#photosurlemur');
    let classphoto = photosurlemur.className;
    let divquimenerve = document.querySelector('.divquimenerve');

    function getClass(format) {
        if (format == 'classique') {
            if (classphoto == 'photosurlemur1') {
                photosurlemur.style = "max-width : 3%";
                divquimenerve.style = "top : 25%";
            } else if (classphoto == 'photosurlemur2') {
                photosurlemur.style = "max-width : 3%"
                divquimenerve.style = "top : 15%";
            } else if (classphoto == 'photosurlemur3') {
                photosurlemur.style = "max-width : 3%"
                divquimenerve.style = "top : 15%";
            } else if (classphoto == 'photosurlemur4') {
                photosurlemur.style = "max-width : 3%"
                divquimenerve.style = "top : 15%";
            }
        } else if (format == 'grand') {
            if (classphoto == 'photosurlemur1') {
                photosurlemur.style = "max-width : 5%";
                divquimenerve.style = "top : 20%";
            } else if (classphoto == 'photosurlemur2') {
                photosurlemur.style = "max-width : 5%"
                divquimenerve.style = "top : 10%";
            } else if (classphoto == 'photosurlemur3') {
                photosurlemur.style = "max-width : 3%"
                divquimenerve.style = "top : 15%";
            } else if (classphoto == 'photosurlemur4') {
